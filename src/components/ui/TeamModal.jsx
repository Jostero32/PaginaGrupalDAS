              ...
              <div className="team-modal-social">
                {member.github && (
                  <a
                    ...
                    className="team-modal-social-link github"
                    aria-label="GitHub"
                  >
                ...
                {member.linkedin && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="team-modal-social-link linkedin"
                    aria-label="LinkedIn"
                  >
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                ...
                {member.portfolio && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="team-modal-social-link portfolio"
            ...
            <div className="team-modal-content-section">
              ...
              {member.skills && member.skills.length > 0 && (
                <div className="team-modal-skills">
                  <h4 className="team-modal-skills-title">Tech Stack & Skills</h4>
                  <div className="team-modal-skills-grid">
                    {member.skills.map((skill, index) => (
                      <span key={index} className="team-modal-skill-badge">
                        {skill}
                      </span>
                    ))}
                  </div>
